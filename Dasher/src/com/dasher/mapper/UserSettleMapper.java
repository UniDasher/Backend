...
public interface UserSettleMapper {
	...
	public List<UserSettle> getListByWid(@Param(value="wid") String wid);
	public List<UserSettle> getSettleByWid(@Param(value="wid") String wid,@Param(value="startDate") String startDate,
			@Param(value="endDate") String endDate);
